...
public class clsProveedor {
    ...
    //Función que permite el registro de dirección
    ...
    //Función que permite el registro de proveedor
    public int Insertar_Proveedor(String str_Codigo, Integer int_Direccion, String str_Cedula, String str_Nombre, String str_Telefono, 
            ...
            String date_FechaCrear, String date_FechaModificar)
    {
        ...
        try {
            con = new Conectar();      
            cst = con.getConnection().prepareCall("{call proveedor_insertar(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
    ...
    //Función para consultar proveedor
    public ResultSet Buscar_Proveedor(String str_Codigo)
    {
        try {
            con = new Conectar();
            cst = con.getConnection().prepareCall("{call proveedor_consultar(?)}");
            cst.setString(1, str_Codigo);
            rs = cst.executeQuery();
            con.Desconectar();
        } catch (Exception e) {
    ...
    //Función para obtener el id del ultimo registro de dirección
    ...
    public int Editar_Direccion(String str_Pais, String str_Ciudad, String str_Calle, String str_CodigoPostal, Integer int_Direccion)
    {
        int res = 0;
        try {
            con = new Conectar();
    ...
    public int Editar_Proveedor(Integer int_Direccion, String str_Cedula, String str_Nombre, String str_Telefono, String str_NombreContacto, 
            ...
            Integer int_PlazoCredito, String str_Estado, String str_Usuario, String date_FechaCrear, String date_FechaModificar, String str_Codigo)
    {
        ...
        try {
            con = new Conectar();
            cst = con.getConnection().prepareCall("{call proveedor_modificar(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
    ...
    public int Borrar_Proveedor (String str_Codigo)
    {
        int res = 0;
        try {
            con = new Conectar();
            cst = con.getConnection().prepareCall("{call proveedor_eliminar(?)}");
            cst.setString(1, str_Codigo);
