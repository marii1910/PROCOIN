...
public interface WsIndicadoresEconomicosSoap {
     ...
     * @param tcFechaFinal
     * @return
     *     returns TipoCambio.ObtenerIndicadoresEconomicosResponse.ObtenerIndicadoresEconomicosResult
     */
    ...
    @RequestWrapper(localName = "ObtenerIndicadoresEconomicos", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "TipoCambio.ObtenerIndicadoresEconomicos")
    @ResponseWrapper(localName = "ObtenerIndicadoresEconomicosResponse", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "TipoCambio.ObtenerIndicadoresEconomicosResponse")
    public TipoCambio.ObtenerIndicadoresEconomicosResponse.ObtenerIndicadoresEconomicosResult obtenerIndicadoresEconomicos(
    ...
    @RequestWrapper(localName = "ObtenerIndicadoresEconomicosXML", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "TipoCambio.ObtenerIndicadoresEconomicosXML")
    @ResponseWrapper(localName = "ObtenerIndicadoresEconomicosXMLResponse", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "TipoCambio.ObtenerIndicadoresEconomicosXMLResponse")
